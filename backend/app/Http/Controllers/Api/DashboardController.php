...
{
    /**
     * How long (in seconds) to cache KPI data.
     * Avoids hitting the database on every dashboard refresh.
     */
    private const CACHE_TTL = 30;

    public function kpis(): JsonResponse
    {
        $data = Cache::remember('dashboard.kpis', self::CACHE_TTL, static function (): array {
